...
instance Eq (TxBodyContent build era) where
  (TxBodyContent _aIns _aCollateral _aOuts _aFee _aValidityRange _aMetadata _aAuxScripts _aExtraKeyWits _aProtocolParams _aWithdrawals _aCertificates _aUpdateProposal _aMintValue _aScriptValidity)
    == (TxBodyContent _bIns _bCollateral _bOuts _bFee _bValidityRange _bMetadata _bAuxScripts _bExtraKeyWits _bProtocolParams _bWithdrawals _bCertificates _bUpdateProposal _bMintValue _bScriptValidity)
    = True
