...
testPartialYamlConfig =
  PartialNodeConfiguration
    ...
    , pncSocketConfig = PartialSocketConfig (Last Nothing) mempty mempty mempty
...
expectedConfig =
  NodeConfiguration
    { ncSocketConfig = SocketConfig Nothing Nothing Nothing Nothing
    , ncShutdownConfig = ShutdownConfig Nothing (MaxSlotNo $ SlotNo 42)
